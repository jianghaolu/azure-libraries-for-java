...
public abstract class ManagerBase {
    ...
    protected ManagerBase(HttpPipeline httpPipeline, String subscriptionId) {
        if (httpPipeline != null) {
            this.resourceManager = ResourceManager.authenticate(httpPipeline).withSubscription(subscriptionId);
        }
