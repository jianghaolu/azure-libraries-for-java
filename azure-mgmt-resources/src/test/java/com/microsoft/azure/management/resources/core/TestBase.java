    ...
    public void beforeTest() throws IOException {
        ...
        if (isPlaybackMode()) {
            ...
            restClient = buildRestClient(new RestClient.Builder()
                    ...
                    .withNetworkInterceptor(new ResourceGroupTaggingRequestPolicyFactory())
            ...
            restClient = buildRestClient(builder.withInterceptor(new ResourceManagerThrottlingRequestPolicyFactory()),false);
